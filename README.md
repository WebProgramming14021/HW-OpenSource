...
- در این تمرین، هر گروه کافی‌ست ۳ سوال در سایت Stackoverflow و ۶ issue در Github انجام دهند و لینک آن‌ها در یک فایل txt به همراه شماره دانشجویی اعضای گروه قرار دهند و در کوئرا آپلود کنند.